...
from backend.processor.Cell_test import printedText
# import backend.processor.vertical
# import backend.processor.rectangle
#import Predict
...
def generateOutputFile(result):
    ...
    # print(df)
    df.to_csv("./media/results/Output.csv",sep=' ',encoding='utf_8',header=False,index=False,na_rep = '')

    dfNew = pd.read_csv("./media/results/Output.csv",sep=' ')
    writer = pd.ExcelWriter("./media/results/Result.xlsx")
